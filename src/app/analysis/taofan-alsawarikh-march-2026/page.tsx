...
export const metadata = {
  ...
  description: 'شهدت الجبهة اللبنانية في الساعات الـ 24 الماضية تحولاً دراماتيكياً.',
};
    ...
    <main dir="rtl" className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <article className="max-w-4xl mx-auto px-6 py-12 space-y-10">
        ...
        <section>
          ...
          <div className="space-y-3">
            {[
              ...
              { title: 'الإسناد المسير', text: 'في تطور نوعي، دمجت المقاومة سلاح الجو المسير مع قوات المشاة، موفرةً إسناداً جوياً قريباً عبر أسراب انقضاضية استهدفت خطوط التماس في الخيام ودبل.' },
            ].map((item) => (
        ...
        <section>
          <h2 className="text-xl font-bold text-red-400 mb-4 flex items-center gap-2">
            <span className="w-6 h-0.5 bg-red-600 inline-block" />
            مناورة النار: الكريوت ودادو تحت القصف الاستراتيجي
          </h2>
          <div className="space-y-3">
            {[
        ...
        <section>
          <h2 className="text-xl font-bold text-red-400 mb-4 flex items-center gap-2">
            <span className="w-6 h-0.5 bg-red-600 inline-block" />
            العدو الإسرائيلي: عجز بري وتعويض بالتفخيخ الهندسي
          </h2>
          <div className="space-y-3">
            {[
